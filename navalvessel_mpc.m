function [xdot,U, M] = navalvessel_mpc(x, ui, Vc, betaVc)
...
%
%
% Modified by Andreas Mork Nordsven to suit his needs
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Include irrotational current and relative velocity here
